...
bool can_castle(Position, Color turn);
bool can_castle_king_side(Position, Color turn);
bool can_castle_queen_side(Position, Color turn);
 ...
 */
CastlingRights castling_update_mask(Position*, Move);
